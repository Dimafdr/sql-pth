...
class Book(Base):
    ...
    id_book = sqlalchemy.Column(sqlalchemy.Integer, primary_kay=True)
...
class Shop(Base):
    ...
    id_shop = sqlalchemy.Column(sqlalchemy.Integer, primary_kay=True)
...
class Stock(Base):
    ...
    id_stock = sqlalchemy.Column(sqlalchemy.Integer, primary_kay=True)
    id_book = sqlalchemy.Column(sqlalchemy.Integer, sqlalchemy.ForeignKey("book.id.book"), nullable=False)
    id_shop = sqlalchemy.Column(sqlalchemy.Integer, sqlalchemy.ForeignKey("shop.id.shop"), nullable=False)
    stock_count = sqlalchemy.Column(sqlalchemy.Integer, nullable=False)
    book = relationship(Book, backref="stock")
    shop = relationship(Shop, backref="stock")

    def __str__(self):
        return f'Stock {self.id_stock} : {self.id_book}, {self.id_shop}, {self.stock_count}'
...
class Sale(Base):
    ...
    id_sale = sqlalchemy.Column(sqlalchemy.Integer, primary_kay=True)
